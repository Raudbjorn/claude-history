...
pub enum AppMode {
    ...
    List,
    /// View mode - reading a conversation (stack[0] = root, stack.last() = current)
    View { stack: Vec<ViewState> },
}
...
pub struct ViewState {
    ...
    /// Maps tool_use_id to agent JSONL path for Task tool calls with linked subagents
    pub subagent_links: HashMap<String, PathBuf>,
    /// The tool_use_id this subagent view was entered from
