...
pub struct Args {
    ...
    /// Enter a conversation, then press Enter again to print its session as JSON and exit
    #[arg(
        long,
        short = 's',
        help = "Enter a conversation, then press Enter again to print its session as JSON and exit",
        conflicts_with_all = ["show_path", "show_id", "resume", "plain", "render", "delete", "input_file"]
    )]
    pub select: bool,
    ...
    #[arg(
        ...
        conflicts_with_all = ["global", "show_dir", "resume", "show_path", "show_id", "plain", "render", "input_file", "select"]
    )]
    ...
    #[arg(
        ...
        conflicts_with_all = ["show_dir", "resume", "show_path", "show_id", "plain", "render", "delete", "input_file", "semantic_search", "select"]
    )]
    ...
    #[arg(
        ...
        hide = true,
        conflicts_with_all = ["show_dir", "resume", "show_path", "show_id", "plain", "render", "delete", "input_file", "debug_search", "semantic_search", "generate_semantic_cache", "clear_semantic_cache", "select"]
    )]
    ...
    #[arg(
        ...
        value_parser = non_empty_string,
        hide = true,
        conflicts_with_all = ["show_dir", "resume", "show_path", "show_id", "plain", "render", "delete", "input_file", "debug_search", "clear_semantic_cache", "select"]
    )]
    ...
    #[arg(
        ...
        hide = true,
        conflicts_with_all = ["show_dir", "resume", "show_path", "show_id", "plain", "render", "delete", "input_file", "debug_search", "semantic_search", "clear_semantic_cache", "select"]
    )]
    ...
    #[arg(
        ...
        hide = true,
        conflicts_with_all = ["show_dir", "resume", "show_path", "show_id", "plain", "render", "delete", "input_file", "debug_search", "semantic_search", "generate_semantic_cache", "debug_semantic_search", "select"]
    )]
    ...
    #[arg(
        ...
        conflicts_with_all = ["global", "local", "show_dir", "resume", "show_path", "show_id", "plain", "render", "delete", "select"]
    )]
...
mod tests {
    ...
    #[test]
    fn cli_select_flag_parses() {
        let args = Args::try_parse_from(["claude-history", "--select"]).unwrap();
        assert!(args.select);
    }

    #[test]
    fn cli_select_conflicts_with_show_path() {
        let err = Args::try_parse_from(["claude-history", "--select", "--show-path"])
            .expect_err("select and show-path should conflict");
        assert!(err.to_string().contains("cannot be used with"));
    }

    #[test]
    fn cli_select_conflicts_with_show_id() {
        let err = Args::try_parse_from(["claude-history", "--select", "--show-id"])
            .expect_err("select and show-id should conflict");
        assert!(err.to_string().contains("cannot be used with"));
    }

    #[test]
    fn cli_select_conflicts_with_resume() {
        let err = Args::try_parse_from(["claude-history", "--select", "--resume"])
            .expect_err("select and resume should conflict");
        assert!(err.to_string().contains("cannot be used with"));
    }

    #[test]
    fn cli_select_allows_local_filter() {
        let args = Args::try_parse_from(["claude-history", "--select", "--local"]).unwrap();
        assert!(args.select);
        assert!(args.local);
    }
}
